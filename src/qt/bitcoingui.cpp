    ...
    rpcConsole(0)
{
    ...
    resize(1000, 600);
    setWindowTitle(tr("SpinCoins") );
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/spc"));
    setWindowIcon(QIcon(":icons/spc"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setToolTip(tr("Show general overview of your SpinCoins balance"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send to an SpinCoins account address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show your list of SpinCoins account addresses for receiving SpinCoins"));
    ...
    charityAction->setToolTip(tr("Stake your SpinCoins for a charity of your choice"));
    ...
    historyAction->setToolTip(tr("Browse your SpinCoins transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/icons/address-book"), tr("&Addresses"), this);
    addressBookAction->setToolTip(tr("Edit the list of your stored SpinCoins account addresses and labels"));
    ...
    blockAction->setToolTip(tr("Explore the SpinCoins blockchain"));
    ...
    statisticsAction->setToolTip(tr("View SpinCoins network statistics"));
    ...
    aboutAction = new QAction(QIcon(":/icons/spc"), tr("&About SpinCoins"), this);
    aboutAction->setToolTip(tr("Show information about SpinCoins"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SpinCoins"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/spc"), tr("&Show / Hide"), this);
    ...
    backupWalletAction = new QAction(QIcon(":/icons/filesave"), tr("&Backup your SpinCoins..."), this);
    backupWalletAction->setToolTip(tr("Backup your SpinCoins to another location"));
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/spc_testnet"));
            setWindowIcon(QIcon(":icons/spc_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/spc_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SpinCoins") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SpinCoins"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the SpinCoins network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(count < nTotalBlocks)
    {
        ...
        {
            progressBarLabel->setText(tr("Synchronizing with the SpinCoins network..."));
        ...
        tooltip = tr("Downloaded %1 of %2 blocks of SpinCoins history (%3% done).").arg(count).arg(nTotalBlocks).arg(nPercentageDone, 0, 'f', 2);
    }
    else
    {
        if (strStatusBarWarnings.isEmpty())
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the SpinCoins network.  "
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SpinCoins address or malformed URI parameters."));
    }
...
void BitcoinGUI::backupWallet()
{
    ...
    QString filename = QFileDialog::getSaveFileName(this, tr("Backup SpinCoins"), saveDir, tr("Wallet Data (*.dat)"));
    if(!filename.isEmpty()) {
        if(!walletModel->backupWallet(filename)) {
            QMessageBox::warning(this, tr("Backup Failed"), tr("There was an error trying to save the SpinCoins data to the new location."));
        }
    }
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            ...
            labelStakingIcon->setToolTip(tr("Not earning interest because you don't have mature SpinCoins"));
        else
