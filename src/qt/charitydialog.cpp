    ...
    model(0)
{
    ...
    ui->charityAddressEdit->setPlaceholderText(tr("Enter Charity SpinCoins Account Address"));
...
void StakeForCharityDialog::on_disableButton_clicked()
{
    ...
    ui->message->setStyleSheet("QLabel { color: black; font-weight: 900;}");
    ui->message->setText(tr("SpinCoins Stake For Charity is now off")+ " \n\n\n");
    return;
}
